...
/**
 * @file
 * Contains Drupal\search_api\Plugin\search_api\datasource\DatasourcePluginBase.
 */

namespace Drupal\search_api\Plugin\search_api\datasource;

/**
 * Default base class for the DatasourceInterface.
 *
 * Contains Drupal\search_api\Plugin\search_api\datasource\DatasourcePluginBase.
 ...
 */
abstract class DatasourcePluginBase implements DatasourceInterface {
   ...
   * @endcode
   *
   * ExternalDatasource::getPropertyInfo() contains a working
  ...
  protected function getPropertyInfo() {
    ...
    throw new DatasourceException(t('No known property information for type @type.', array('@type' => $this->type)));
  }
  ...
  protected function getAllItemIds() {
    throw new DatasourceException(t('Items not known for type @type.', array('@type' => $this->type)));
  }
   ...
   */
  protected function checkIndex(Index $index) {
